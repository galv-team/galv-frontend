    ...
    return types.map((type) => {
        ...
        const outputs = types
            ...
            .reduce((acc, outputType) => {
                acc[outputType] = {
                    _type: outputType as TypeValueNotation['_type'],
                    _value: null,
                }
                return acc
...
const cases = [
    ...makeNullCases(),
    {
        ...
        outputs: {
            ...
            // hard-coded to the VITE_GALV_API_BASE_URL env var value
            galv_CELL: {
                _type: 'galv_CELL',
                _value: `http://localhost:8080/cells/1`,
            },
        },
    },
    {
        ...
        outputs: {
            ...
            array: {
                _type: 'array',
                _value: [{ _type: 'string', _value: 'true' }],
            },
            object: {
                _type: 'object',
    ...
    },
    {
        ...
        outputs: {
            ...
            array: {
                _type: 'array',
                _value: [{ _type: 'string', _value: 'false' }],
            },
            object: {
                _type: 'object',
    ...
    },
    {
        ...
        outputs: {
            ...
            array: {
                _type: 'array',
                _value: [{ _type: 'boolean', _value: true }],
            },
            object: {
                _type: 'object',
...
describe('Type conversion', () => {
    test.each(expanded_cases)(
        '%#: %o to %s gives %o',
        (input, outputType, expected) => {
