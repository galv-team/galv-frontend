...
import {file_applicable_mappings, files, file_summary, teams} from "./fixtures/fixtures";
...
const default_mapping = file_applicable_mappings.find(m => m.mapping.url === file.mapping)
...
it('renders', async () => {
            ...
            <MemoryRouter initialEntries={["/"]}>
                <QueryClientProvider client={queryClient}>
                    <FetchResourceContextProvider>
                        <ApiResourceContextProvider resource_id={file.id} lookup_key={LOOKUP_KEYS.FILE}>
                            <Mapping/>
        ...
        const other_map = file_applicable_mappings.find(m => m.mapping.url !== file.mapping)!.mapping
        ...
        check_api_call(
            req.mock.calls.reverse().find(call => call[0].method === 'POST')![0] as {data: string}
        )
    },
    3600000)
