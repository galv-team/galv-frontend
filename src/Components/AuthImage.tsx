...
export default function AuthImage({file}: {file: {id: string, path: string, name?: string, png: string}}) {
    ...
    if (imageData) {
        return <img src={imageData} alt={`Preview of data in ${file.name || file.path}`} />
    }
    ...
    return <img src={file.png} alt={`Preview of data in ${file.name || file.path}`} />
}
