...
export default function TeamSummary({ resource } : { resource: BaseResource}) {
    ...
    return <Stack className={clsx(classes.resourceSummary)} spacing={1}>
        ...
        <Stack direction="row">Members: <ChipList chips={r.member_group as unknown as string[]}/></Stack>
    </Stack>
}
